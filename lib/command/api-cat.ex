defmodule BotDiscord.Command.ApiCat do
  @moduledoc """
  Gera uma imagem aleatória da API https://http.cat com base em status codes HTTP.
  """
  ...
  @doc """
  Retorna uma URL aleatória da API http.cat com base em um status code válido.
  """
  def imagem_aleatoria do
    codigo = Enum.random(@valid_status_codes)
    "https://http.cat/#{codigo}.jpg"
  end
end
